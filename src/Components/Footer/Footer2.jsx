        ...
        <div className="mx-10 space-y-5 grid grid-cols-3  mt-5 font-lota justify-evenly">
            ...
            <div>
                ...
                <div className="flex w-64 h-[40px] gap-8 cursor-pointer">
                    <FontAwesomeIcon icon={faInstagram} style={{ color: "#878787", fontSize: "1.7rem" }} />
                    <FontAwesomeIcon icon={faTwitter} style={{ color: "#878787", fontSize: "1.7rem" }} />
                    <FontAwesomeIcon icon={faFacebookF} style={{ color: "#878787", fontSize: "1.5em" }} />
                    <FontAwesomeIcon icon={faLinkedinIn} style={{ color: "#878787", fontSize: "1.7rem" }} />
                </div>
